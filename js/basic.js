...
console.log("\n");
console.log("Expected output of findLongestWord([okay,Andrew,vowel]) is 5 " + myFunctionTest(5, () => findLongestWord("okay", "Andrew", "vowel")));
console.log("Expected output of findLongestWord([okay,Andrew,vowel]) is 5 " + myFunctionTest(3, () => findLongestWord("okay", "Andrew", "vowel")));

console.log("\n");
console.log("Expected output of filterLongWords(4,[okay,Andrew,vowel]) is [Andrew,vowel] " + myFunctionArrayTest(['Andrew', 'vowel'], () => filterLongWords(4, 'okay', 'Andrew', 'vowel')));
console.log("Expected output of filterLongWords(4,[okay,Andrew,vowel]) is [Andrew,vowel] " + myFunctionArrayTest(['Andrew'], () => filterLongWords(4, 'okay', 'Andrew', 'vowel')));
